...
@main function run(dataset::Integer, sample::Integer)
    cd("$(dataset)_$(sample)")
    println(pwd())
    ...
    tryrm("infer.xgmml")
    PKTFX.infer("sim/X_sim.mat", nₜ, nₚ; lambda=.1, epochs=15000)
    PKTFX.infer("sim/X_sim.mat", nₜ, nₚ, "WT_infer_V.mat", "WP_infer_V.mat"; lambda=.1, epochs=2000, PKPP="sim/PKPP.mat", WT="WT_infer.mat", WP="WP_infer.mat")
