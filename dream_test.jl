...
for net ∈ 1:5
    ...
    tryrm("infer.xgmml")
    PKTFX.infer("sim/X_sim.mat", nₜ, nₚ; lambda_W=lambda_W, lambda_B=lambda_B, epochs=5000)
    PKTFX.infer("sim/X_sim.mat", nₜ, nₚ, "WT_infer_V.mat", "WP_infer_V.mat"; lambda_W=lambda_W, lambda_B=lambda_B, epochs=1000, PKPP="sim/PKPP.mat", WT="WT_infer.mat", WP="WP_infer.mat")
