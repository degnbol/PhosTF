...
# read
targets = read.table("raw/BIOGRID-PTM-3.5.178.ptmtab.tsv", sep="\t", header=T, quote="")
sources = read.table("raw/BIOGRID-PTM-RELATIONSHIPS-3.5.178.ptmrel.tsv", sep="\t", header=T, quote="")
