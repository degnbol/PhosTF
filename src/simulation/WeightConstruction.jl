...
"""
Mask of edges that leads to dead-ends, which are phosphorylation regulation leading to nodes that regulate nothing.
"""
...
"""
function check(arr::AbstractMatrix, msg)
	if any(arr)
		arr = findall(arr)
		@warn("$msg: $arr")
	end
